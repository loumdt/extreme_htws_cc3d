...
echo "Percentile threshold is $4th"
...
FILE=Data/ERA5/t2m/$1_daily_avg_$2_$3_smoothed.nc
if test -f "$FILE"; then
...
FILE=Data/ERA5/t2m/distrib_$1_ano_$2_$3_$4th_threshold_15days.nc
if test -f "$FILE"; then
    echo "$FILE already exists, skipping this step"
else
...
FILE=Data/ERA5/t2m/$1_anomaly_JJA_$2_$3_scaled_$4th.nc
if test -f "$FILE"; then
    echo "$FILE already exists, skipping this step"
else
...
FILE=Data/ERA5/Detection_Canicule/potential_heatwaves_$1_$5days_before_scan_$2_$3_$4th.nc.nc
if test -f "$FILE"; then
    echo "$FILE already exists, skipping this step"
else
...
FILE=Data/ERA5/Detection_Canicule/detected_heatwaves_$1_anomaly_JJA_$2_$3_threshold_$4th_$5days.nc
if test -f "$FILE"; then
    echo "$FILE already exists, skipping this step"
else
...
FILE=Data/ERA5/Output/ERA5/$1/$1_$2_$3_$4th_threshold_$5days/emdat_undetected_heatwaves_ERA5_$1_$2_$3_$4th_threshold_$5days.txt
if test -f "$FILE"; then
    echo "$FILE already exists, skipping this step"
else
