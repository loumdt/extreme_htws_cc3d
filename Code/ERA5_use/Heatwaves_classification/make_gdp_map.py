...
nc_out_path = os.path.join(datadir,"ERA5","Socio_eco_maps","GDP_cap_ERA5_Europe_0.25deg.nc")
...
for country in tqdm(country_dict.keys()):
    f_mask=nc.Dataset(os.path.join(datadir, "ERA5","Mask","Mask_"+country+"_ERA5_0.25deg.nc"),mode='r')
