...
nc_out_path = os.path.join(datadir,"ERA5","t2m",the_variable+"_daily_avg_"+str(year_beg)+"_"+str(year_end)+"_smoothed.nc")
...
t2m = nc_file_out.createVariable('t2m',np.float64,('time','lat','lon')) # note: unlimited dimension is leftmost
