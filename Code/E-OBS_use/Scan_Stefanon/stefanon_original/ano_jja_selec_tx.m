clear all
load /home/ajeze/Documents/DetectionCanicule/tx
...
ano = reshape(var,length(lon),length(lat),92,an);
...
var  = reshape(ano,length(lon),length(lat),92*69);
whos


save -v7.3 /home/ajeze/Documents/DetectionCanicule/ano/tx_JJA lat lon temps var var_name var_unit
