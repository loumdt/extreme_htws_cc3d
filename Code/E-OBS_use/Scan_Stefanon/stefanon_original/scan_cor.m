...
data_filename = 'D:/Ubuntu/PFE/Data/E-OBS/0.1deg/temp_anomaly_summer_only_1950-2020.nc'
...
calc_red = 0;
   ...
   ano_scale = ano - seuil;
   clear seuil
%red, on ne garde les anomalies que pour les jours o� ano>T95, sinon on met tout � z�ro
   for j = 1 : siz(3)
      for i = 1 :  siz(1) * siz(2)
   ...
   eval([' save -v7.3 red_' int2str(quantieme) '_scale.mat red ; '])
display('seuil calc');
...
%on fait l'op�ration de scan de chaque zone, pour d�terminer les dates des vagues de chaleur qui sont stock�es dans date
