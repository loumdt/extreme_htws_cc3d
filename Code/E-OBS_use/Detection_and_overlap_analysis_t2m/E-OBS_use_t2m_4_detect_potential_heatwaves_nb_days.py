...
nc_in_path = os.path.join(datadir , "E-OBS" , "t2m" , the_variable+'_anomaly_JJA_'+str(year_beg)+'_'+str(year_end)+'_scaled_'+str(threshold_value)+'th.nc')
#%%    
...
#%%
#-------------------
nc_out_path = os.path.join(datadir , "E-OBS" ,"t2m", "Detection_Canicule" , "potential_heatwaves_"+the_variable+"_"+str(nb_days)+"days_before_scan_"+str(year_beg)+"_"+str(year_end)+"_"+str(threshold_value)+"th.nc")
