...
#%%
#Load E-OBS mask -> masked African and Middle-East countries, and ocean and sea
...
nc_file_temp = os.path.join(datadir, "E-OBS", "t2m", the_variable+"_anomaly_JJA_"+str(year_beg)+"_"+str(year_end)+".nc")
...
with open(os.path.join("Output","E-OBS",the_variable,the_variable+"_"+str(year_beg)+"_"+str(year_end)+"_"+str(threshold_value)+"th_threshold_"+str(nb_days)+"days","emdat_undetected_heatwaves_E-OBS_"+the_variable+"_"+str(year_beg)+"_"+str(year_end)+"_"+str(threshold_value)+"th_threshold_"+str(nb_days)+"days.txt"),'r') as f_txt:
