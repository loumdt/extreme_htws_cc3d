library(corrplot);
dataset<-read.table("/home/theom/Bureau/Ubuntu_SSD/PFE/Data/EM-DAT/emdat_Europe_1950-2021_converted_EXTRACT.csv",h=TRUE,sep=",",dec=".") ;
attach(dataset) ;
names(dataset) ;
...
png(file = "Mat_correlation_all_1179.png", width = 800, height = 700)
