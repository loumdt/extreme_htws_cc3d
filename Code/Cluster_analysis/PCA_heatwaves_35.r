...
png(file = "Heatwaves_grouped_by_events/PCA_explained_variance_heatwaves_35.png", width = 1200, height = 1000) ;
barplot(eig.val[, 2], 
...
png(file = "Heatwaves_grouped_by_events/PCA_proj_ind_dims_1_2_heatwaves_35.png", width = 1200, height = 1000) ;
...
png(file = "Heatwaves_grouped_by_events/PCA_proj_var_dims_1_2_heatwaves_35.png", width = 1200, height = 1000) ;
