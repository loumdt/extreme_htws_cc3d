...
options(ggrepel.max.overlaps = 35)

Palette_0 = brewer.pal(n=7, name='Dark2')

png(file = "Heatwaves_grouped_by_events/Dendrogramme_and_clusters_heatwaves_35.png", width = 1500, height = 1300)
fviz_dend(res.hcpc, 
          cex = 1.4,                     # Taille du texte
...
Palette_1[[2]]<-Palette_0[[3]]
Palette_1[[3]]<-Palette_0[[4]]
Palette_1[[4]]<-Palette_0[[7]]
Palette_1[[5]]<-Palette_0[[6]]
Palette_1[[6]]<-Palette_0[[5]]
Palette_1[[7]]<-Palette_0[[2]]

png(file = "Heatwaves_grouped_by_events/Dendrogramme_and_clusters_fact_map_heatwaves_35.png", width = 1000, height = 900)
...
png(file = "Heatwaves_grouped_by_events/Dendrogramme_and_clusters_fact_map_3D_heatwaves_35.png", width = 1000, height = 900)
plot(res.hcpc, choice = "3D.map" ,angle=30)
dev.off()
