...
{
   # Display Help
   echo "This script carries out a regridding process of the population density files to the ERA5 data grid."
}
...
do
  ...
  if [ $1 = 'Mollweide' ]; then
    echo "Reproject ${year} ..."
    echo ""
    gdalwarp -t_srs EPSG:4326 "GHS_POP_E${year}_GLOBE_R2022A_${coord_sys_dict[${1}]}_$2_V1_0.tif" "GHS_POP_E${year}_GLOBE_R2022A_4326_$2_V1_0.tif"
  ...
  echo ""
  echo Regrid ${year} to ERA5 grid
  echo ""
  cdo -remapycon,Mask_Europe_land_only_ERA5_0.25deg.nc GHS_POP_E${year}_GLOBE_R2022A_4326_${2}_V1_0.nc GHS_POP_${year}_era5_grid_Europe.nc
done