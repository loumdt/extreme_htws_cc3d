"""This script is used to create mask for individual countries, and to create a global mask file for the E-OBS European zone"""
#%%
import numpy as np
...
for idx_country in range(len(list_countries)) :
    ...
    plt.savefig('Mask/test_mask'+country2+'.png')
    #plt.show()
